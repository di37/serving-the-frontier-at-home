...
The scope of this edition (v4.0) is two nodes. The four-Spark TP=4 lane of
\Cref{ch:transplants} and any checkpoint larger than what two 128\,GB nodes
hold are named but not measured, and both are held for a later edition rather
than estimated here.
