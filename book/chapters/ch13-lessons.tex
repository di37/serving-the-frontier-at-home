...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.80\textwidth]{figures/toon-ch13-lessons.png}
\caption{What the principles are made of. A flag that was exactly right and
still wrong, a rug pulled out from under a booting rank, a pattern traced
through pure noise, a cable that connected everything and explained nothing.
Every rule in this chapter is the residue of one of them, which is why the
list reads as it does: eight of eleven plausible performance knobs rejected,
and the most consequential bug in the system a configuration field that
existed, defaulted sensibly, and was never read.}
\label{fig:toon-lessons}
\end{figure}
